...
export class ShadowDatabase {
  ...
  listRuns(filters?: { status?: string; statuses?: string[]; repoId?: string; repoIds?: string[]; parentRunId?: string; parentRunIds?: string[]; parentRunIdIsNull?: boolean; suggestionId?: string; archived?: boolean; startedAfter?: string; limit?: number; offset?: number }): RunRecord[] { return execution.listRuns(this.database, filters); }
  countRuns(filters?: { status?: string; statuses?: string[]; repoId?: string; parentRunIdIsNull?: boolean; archived?: boolean }): number { return execution.countRuns(this.database, filters); }
  ...
  listPlannedRunsForAutoExec(): RunRecord[] { return execution.listPlannedRunsForAutoExec(this.database); }
